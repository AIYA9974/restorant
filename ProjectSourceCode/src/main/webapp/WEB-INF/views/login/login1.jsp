...
<body>
    <section class="login-form">
        ...
        <form action="${getContext.request.contextPath}/mini/login/servlet" method ="get">
            <div class="int-area">
    ...
    <script>
        ...
        $.ajax({
        	url : "${getContext.request.contextPath}/mini/loginse",
        	method : "get",
        	id : $("[name=id]").val() , 
        	pwd : $("[name=pwd]").val(),
        	success : function(result){
        		...
        		if(result < 0){
        			alert("반갑습니다");
        			location,herf="${pageContext.request.contextPath}/home";
