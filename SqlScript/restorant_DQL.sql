...
UPDATE MEMBER SET PASSWORD = 'TEST' , EMAIL = 'TEST' , PHONE = 123123123  WHERE MEMBER_CODE = 24162304471111;


SELECT * FROM RESTORANT;

UPDATE restorant SET restorant_kind = 'KR' WHERE restorant_code ='24050705470095';
