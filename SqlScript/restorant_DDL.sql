...
COMMENT ON COLUMN "RESTORANT"."MEMBER_CODE" IS '외래 키 FOREGIN KEY';

COMMENT ON COLUMN "RESTORANT"."RESTORANT_AREA" IS '레스토랑 음식 분야';
...
ALTER TABLE "RESTORANT" ADD CONSTRAINT "FK_MEMBER_TO_RESTORANT_1" FOREIGN KEY (
	"MEMBER_CODE"
)
REFERENCES "MEMBER" (
	"MEMBER_CODE"
